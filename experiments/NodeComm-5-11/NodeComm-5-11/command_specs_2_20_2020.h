 ...
 *  Author: Michael, James Hoyland
 * This will specify the various commands that a chip can recieve
 */ 
#ifndef __CMD_SPEC_H
#define __CMD_SPEC_H
...
#define CMD_LOOK_UP
#define CMD_PROBE_NEIGHBORS					//use this for my HOWDY NEIGHBOR function
...
#define CMD_TO_END			0x00CE			//CE continue (to) end
#define CMD_TRACE
